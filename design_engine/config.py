...
try:
    ...
    # Handle cases where gemini_key is not yet declared in secret_key.py
    try:
...
class Config:
    ...
    # Path configurations using pathlib (goes up 2 levels from design_engine/config.py to root)
