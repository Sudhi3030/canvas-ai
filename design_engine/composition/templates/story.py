...
class StoryTemplate:
    ...
    def build(spec: TemplateSpec, brand: BrandKit, logo: str, heading: str, body: str, cta: str, hero_url: str) -> Layout:
        ...
        headline_node = TextNode(id="heading", name="Headline", width_policy="fill", height_policy="fit", z_index=2, properties={"content": heading, "font_family": "Arial", "font_size": 42.0, "color": "#000000", "align": "center"})
        
        # Hero Image fills the center area
        hero_h = float(spec.height) * 0.40
        hero_node = ImageNode(id="hero", name="Story Image", width=float(spec.width - 60), height=hero_h, width_policy="fixed", height_policy="fixed", z_index=2, properties={"url": hero_url, "fit_mode": "cover"})
        ...
        content_stack = GroupNode(
            ...
            layout_mode="vertical", spacing=25.0, padding_left=30.0, padding_right=30.0, padding_top=40.0, padding_bottom=40.0,
