...
class BentoTemplate:
    ...
    def build(spec: TemplateSpec, brand: BrandKit, logo: str, heading: str, body: str, cta: str, hero_url: str) -> Layout:
        ...
        # Grid blocks wrap
        hero_w = float(spec.width - 120)
        hero_h = float(spec.height) * 0.35
        hero_node = ImageNode(id="hero", name="Hero Image", width=hero_w, height=hero_h, width_policy="fixed", height_policy="fixed", z_index=2, properties={"url": hero_url, "fit_mode": "cover"})
        ...
        content_stack = GroupNode(
            ...
            layout_mode="wrap", spacing=15.0, padding_left=30.0, padding_right=30.0, padding_top=30.0, padding_bottom=30.0,
