...
class PosterTemplate:
    ...
    def build(spec: TemplateSpec, brand: BrandKit, logo: str, heading: str, body: str, cta: str, hero_url: str) -> Layout:
        ...
        # Enormous Headline
        headline_node = TextNode(id="heading", name="Headline", width_policy="fill", height_policy="fit", z_index=2, properties={"content": heading, "font_family": "Arial", "font_size": 64.0, "color": "#000000", "align": "center"})
        
        # Image shrunken at the bottom
        hero_node = ImageNode(id="hero", name="Hero Image", width=250.0, height=180.0, width_policy="fixed", height_policy="fixed", z_index=2, properties={"url": hero_url, "fit_mode": "cover"})
        ...
        content_stack = GroupNode(
            ...
            layout_mode="vertical", spacing=25.0, padding_left=40.0, padding_right=40.0, padding_top=40.0, padding_bottom=40.0,
